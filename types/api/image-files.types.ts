...
export type ImageFilesOperations = "ImageFilesController_upload" | "ImageFilesController_findByBucket" | "ImageFilesController_findOne" | "ImageFilesController_serveImageById" | "ImageFilesController_remove" | "ImageFilesController_serveThumbnailById" | "ImageFilesController_serveByFullUri" | "ImageFilesController_serveByUri" | "ImageFilesController_serveThumbnailByUri";
...
export const IMAGE_FILES_ENDPOINTS = {
  ...
  BY_ID_DETAIL: (path: string) => `/files/images/${path}`,
