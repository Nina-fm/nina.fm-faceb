...
export type GetDB<T extends keyof DbTables, F extends keyof DbTables[T]> = DbTables[T][F]
...
export type SplitRelStr<RelStr extends string> = RelStr extends `${infer T}(${infer Q})`
